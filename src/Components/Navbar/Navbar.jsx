...
const Navbar = () => {
	const totalAmount = useSelector((state) => state.cart.noOfItems);
	...
	return (
		<div className="shadow pr-2 pl-2">
			<div className="flex items-center justify-between">
				<a href="/" target="_blanck">
					<img
						className="h-28 w-full"
						src={
							'https://images-platform.99static.com/pB8zc_qLgN8SNj-6Q00E3VJldBs=/0x0:1501x1501/500x500/top/smart/99designs-contests-attachments/116/116827/attachment_116827616'
						}
						alt="logo"
					/>
				</a>
